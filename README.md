...
<BR>
Result: Half year testing: BMP180, BME280 are good to measure temperature and pressure, parameters are according datasheet. BME280 (maybe my item) cannot measure outside humidity  normally. BME680 do it well, plus has gas sensor. So, more expensive BME680 won this project.<BR>
Expansive board: it can charge battery (I=150 mA) and power esp32-C3 Super Mini from battery as long as voltage down  to 3.5 V (usually 1-2 weeks in sleep mode for std 18650 li-ion 2000 mA). "Sandwich" consume energy from USB-C 5 V about 50-85 mA in work mode, in light sleep mode 7 mA, deep sleep - 5,5 mA. But there is big fault: boart turn voltage of battery to USB-C connector. It made for me a lot of problems.<BR>
